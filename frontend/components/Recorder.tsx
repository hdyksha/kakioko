...
export function Recorder({ onRecordingComplete, isLoading, prompt, setPrompt, language, setLanguage, modelName, setModelName, useGpu, setUseGpu, mode }: RecorderProps) {
